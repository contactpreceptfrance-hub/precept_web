  ...
  return (
    <section className="relative min-h-[320px] flex items-center overflow-hidden bg-[#0c1f3f]">
      ...
      <div className="relative z-10 px-6 sm:px-12 py-16 max-w-2xl">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 border border-white/40 text-white rounded-full text-xs font-semibold uppercase tracking-widest mb-5">
          📚 Notre Boutique
        </div>
